...
<template>
  <div class="h-full">
    <Teleport defer to="#title">
      <h1 class="text-[28px] leading-[34px] text-slate-12 dark:text-slate-50 font-bold">爆文导入</h1>
    </Teleport>

    <div class="flex flex-col h-full gap-4 px-3 py-3 overflow-auto">
      <!-- 操作区 -->
